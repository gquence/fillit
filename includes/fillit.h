...
/*   Updated: 2019/04/09 12:52:24 by gquence          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			out_l_vertical_down(char **field, int pos, char c, int field_size);
...
void			out_l_vertical_up(char **field, int pos, char c, int field_size);
...
typedef void	(*del_func)(long *field, int size, int pos);
typedef void	(*out_func)(char **field, int pos, char c, int size);
...
int				find_tetro_id(const unsigned short int number, size_t b_border, size_t h_border);
